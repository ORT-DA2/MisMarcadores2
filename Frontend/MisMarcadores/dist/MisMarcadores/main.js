...
module.exports = "<p> Home Component</p>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(sessionService, userService, router, notificationService) {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.userService.postLogin(this.model).subscribe(function (response) {
            if (response) {
                ...
                _this.sessionService.setSession(response);
                if (_this.sessionService.isAuthenticated) {
                    _this.router.navigate([_this.sessionService.attemptedUrl]);
                }
            }
            else {
                _this.notificationService.display({ message: 'Invalid username or password', severity: 'error' });
            }
        }, function () {
            _this.notificationService.display({ message: 'Error occurred', severity: 'error' });
        });
    };
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_session_service__WEBPACK_IMPORTED_MODULE_1__["SessionService"],
...
var BaseApiService = /** @class */ (function () {
    function BaseApiService(http, sessionService) {
        this.http = http;
        this.sessionService = sessionService;
    ...
    BaseApiService.prototype.getHeader = function (tokenRequired) {
        return tokenRequired ?
            new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Authorization': this.sessionService.getToken() }) :
...
var SessionService = /** @class */ (function () {
    ...
    SessionService.prototype.logOff = function () {
        localStorage.removeItem('token');
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _base_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base-api.service */ "./src/app/service/base-api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserService = /** @class */ (function () {
    function UserService(baseApiService) {
        this.baseApiService = baseApiService;
    }
    UserService.prototype.postLogin = function (request) {
        return this.baseApiService.post('login', request);
    };
    UserService.prototype.registerUser = function (request) {
        return this.baseApiService.post('users', request, true);
    };
    UserService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_base_api_service__WEBPACK_IMPORTED_MODULE_1__["BaseApiService"]])
    ], UserService);
    return UserService;
}());
